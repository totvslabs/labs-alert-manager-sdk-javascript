...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Alertmanager.PolicySchema();
  });
  ...
  describe('PolicySchema', function() {
    it('should create an instance of PolicySchema', function() {
      // uncomment below and update the code to test PolicySchema
      //var instance = new Alertmanager.PolicySchema();
      //expect(instance).to.be.a(Alertmanager.PolicySchema);
    });
    ...
    it('should have the property frequencyMinutes (base name: "frequency_minutes")', function() {
      // uncomment below and update the code to test the property frequencyMinutes
      //var instance = new Alertmanager.PolicySchema();
      //expect(instance).to.be();
    });

    it('should have the property frequencyOccurrences (base name: "frequency_occurrences")', function() {
      // uncomment below and update the code to test the property frequencyOccurrences
      //var instance = new Alertmanager.PolicySchema();
      //expect(instance).to.be();
    });
