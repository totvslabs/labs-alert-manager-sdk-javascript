...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Alertmanager.DocsApi();
  });
  ...
  describe('DocsApi', function() {
    ...
    describe('getSwaggerYml', function() {
      it('should call getSwaggerYml successfully', function(done) {
        //uncomment below and update the code to test getSwaggerYml
        //instance.getSwaggerYml(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
